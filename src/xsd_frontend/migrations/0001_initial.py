    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_made_by', models.ForeignKey(related_name='request_made_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('response_by', models.ForeignKey(related_name='response_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('site', models.ForeignKey(blank=True, to='xsd_sites.Site', null=True)),
            ],
            options={
            },
            bases=(models.Model,),
