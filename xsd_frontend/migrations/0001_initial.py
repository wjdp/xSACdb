...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'xsd_frontend_updaterequest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('area', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('lesson', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['xsd_training.Lesson'], null=True, blank=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['xsd_sites.Site'], null=True, blank=True)),
            ('request_body', self.gf('django.db.models.fields.TextField')()),
            ('request_made_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='request_made_by', blank=True, to=orm['auth.User'])),
            ('response_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='response_by', blank=True, to=orm['auth.User'])),
            ('completed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'xsd_frontend', ['UpdateRequest'])


    def backwards(self, orm):
        # Deleting model 'UpdateRequest'
        db.delete_table(u'xsd_frontend_updaterequest')
    ...
    models = {
        ...
        u'xsd_frontend.updaterequest': {
            ...
            'request_made_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'request_made_by'", 'blank': 'True', 'to': u"orm['auth.User']"}),
            'response_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'response_by'", 'blank': 'True', 'to': u"orm['auth.User']"}),
