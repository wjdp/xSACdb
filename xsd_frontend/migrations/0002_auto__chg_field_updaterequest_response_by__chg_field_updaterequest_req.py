...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UpdateRequest.response_by'
        db.alter_column(u'xsd_frontend_updaterequest', 'response_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'UpdateRequest.request_made_by'
        db.alter_column(u'xsd_frontend_updaterequest', 'request_made_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'UpdateRequest.response_by'
        raise RuntimeError("Cannot reverse this migration. 'UpdateRequest.response_by' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'UpdateRequest.request_made_by'
        raise RuntimeError("Cannot reverse this migration. 'UpdateRequest.request_made_by' and its values cannot be restored.")
