...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UpdateRequest.sent'
        db.add_column(u'xsd_frontend_updaterequest', 'sent',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 2, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UpdateRequest.sent'
        db.delete_column(u'xsd_frontend_updaterequest', 'sent')
