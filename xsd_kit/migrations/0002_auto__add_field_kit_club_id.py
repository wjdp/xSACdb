...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Kit.club_id'
        db.add_column(u'xsd_kit_kit', 'club_id',
                      self.gf('django.db.models.fields.CharField')(default='FAIL', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Kit.club_id'
        db.delete_column(u'xsd_kit_kit', 'club_id')
