...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MemberProfile.facebook_id'
        db.add_column(u'xsd_members_memberprofile', 'facebook_id',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MemberProfile.facebook_id'
        db.delete_column(u'xsd_members_memberprofile', 'facebook_id')
