...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MemberProfile.new'
        db.add_column(u'xsd_members_memberprofile', 'new',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MemberProfile.new'
        db.delete_column(u'xsd_members_memberprofile', 'new')
