...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MemberProfile.picture'
        db.add_column(u'xsd_members_memberprofile', 'picture',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MemberProfile.picture'
        db.delete_column(u'xsd_members_memberprofile', 'picture')
