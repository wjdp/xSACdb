...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MemberProfile.new_token_required'
        db.add_column(u'xsd_members_memberprofile', 'new_token_required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'MemberProfile.facebook_open_graph'
        db.alter_column(u'xsd_members_memberprofile', 'facebook_open_graph', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):
        # Deleting field 'MemberProfile.new_token_required'
        db.delete_column(u'xsd_members_memberprofile', 'new_token_required')


        # Changing field 'MemberProfile.facebook_open_graph'
        db.alter_column(u'xsd_members_memberprofile', 'facebook_open_graph', self.gf('django.db.models.fields.BooleanField')())
