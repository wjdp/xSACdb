...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PerformedLesson.date'
        db.add_column(u'xsd_training_performedlesson', 'date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PerformedLesson.date'
        db.delete_column(u'xsd_training_performedlesson', 'date')
