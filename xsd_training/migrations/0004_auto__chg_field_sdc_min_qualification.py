...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SDC.min_qualification'
        db.alter_column(u'xsd_training_sdc', 'min_qualification_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['xsd_training.Qualification'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SDC.min_qualification'
        raise RuntimeError("Cannot reverse this migration. 'SDC.min_qualification' and its values cannot be restored.")
    ...
    models = {
        ...
        u'xsd_training.performedlesson': {
            ...
            'session': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['xsd_training.Session']", 'blank': 'True'}),
