...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field interested_members on 'SDC'
        db.create_table(u'xsd_training_sdc_interested_members', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('sdc', models.ForeignKey(orm[u'xsd_training.sdc'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(u'xsd_training_sdc_interested_members', ['sdc_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field interested_members on 'SDC'
        db.delete_table('xsd_training_sdc_interested_members')
    ...
    models = {
        ...
        u'xsd_training.sdc': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interested_members': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['auth.User']", 'symmetrical': 'False'}),
