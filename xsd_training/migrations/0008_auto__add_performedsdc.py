...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PerformedSDC'
        db.create_table(u'xsd_training_performedsdc', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sdc', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['xsd_training.SDC'])),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('completed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'xsd_training', ['PerformedSDC'])

        # Adding M2M table for field trainees on 'PerformedSDC'
        db.create_table(u'xsd_training_performedsdc_trainees', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('performedsdc', models.ForeignKey(orm[u'xsd_training.performedsdc'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(u'xsd_training_performedsdc_trainees', ['performedsdc_id', 'user_id'])


    def backwards(self, orm):
        # Deleting model 'PerformedSDC'
        db.delete_table(u'xsd_training_performedsdc')

        # Removing M2M table for field trainees on 'PerformedSDC'
        db.delete_table('xsd_training_performedsdc_trainees')
