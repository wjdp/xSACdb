...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SDC.category'
        db.add_column(u'xsd_training_sdc', 'category',
                      self.gf('django.db.models.fields.CharField')(default='non', max_length=3),
                      keep_default=False)

        # Adding field 'SDC.other_requirements'
        db.add_column(u'xsd_training_sdc', 'other_requirements',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SDC.category'
        db.delete_column(u'xsd_training_sdc', 'category')

        # Deleting field 'SDC.other_requirements'
        db.delete_column(u'xsd_training_sdc', 'other_requirements')
