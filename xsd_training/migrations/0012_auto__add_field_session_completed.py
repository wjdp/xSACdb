...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Session.completed'
        db.add_column(u'xsd_training_session', 'completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Session.completed'
        db.delete_column(u'xsd_training_session', 'completed')
