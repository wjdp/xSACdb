...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Qualification.code'
        db.add_column(u'xsd_training_qualification', 'code',
                      self.gf('django.db.models.fields.CharField')(default='NUL', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Qualification.code'
        db.delete_column(u'xsd_training_qualification', 'code')
