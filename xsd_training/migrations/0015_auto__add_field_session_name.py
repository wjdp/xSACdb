...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'xsd_training_session', 'name',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'xsd_training_session', 'name')
    ...
    models = {
        ...
        u'xsd_training.lesson': {
            'Meta': {'ordering': "['qualification', 'mode', 'order']", 'object_name': 'Lesson'},
        ...
        u'xsd_training.session': {
            'Meta': {'ordering': "['when']", 'object_name': 'Session'},
            'completed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'xsd_training.traineegroup': {
            'Meta': {'ordering': "['name']", 'object_name': 'TraineeGroup'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
